...
const messages = {
  tr: {
    nav: { home: "Ana Sayfa", discover: "Keşfet", messages: "Mesajlar", profile: "Profil", search: "Film ara...", main: "Ana navigasyon", mobile: "Mobil navigasyon", unread: "Okunmamış mesaj", homeLink: "Movie Tracker ana sayfa", profileLabel: "Profil", user: "Kullanıcı" },
  ...
  en: {
    nav: { home: "Home", discover: "Discover", messages: "Messages", profile: "Profile", search: "Search films...", main: "Main navigation", mobile: "Mobile navigation", unread: "Unread message", homeLink: "Movie Tracker home", profileLabel: "Profile", user: "User" },
