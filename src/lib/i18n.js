...
const messages = {
  tr: {
    nav: { home: "Ana Sayfa", discover: "Keşfet", messages: "Mesajlar", profile: "Profil", search: "Film ara...", main: "Ana navigasyon", sidebar: "Yan menü", openMenu: "Menüyü aç", closeMenu: "Menüyü kapat", openSidebar: "Yan menüyü aç", closeSidebar: "Yan menüyü kapat", mobile: "Mobil navigasyon", unread: "Okunmamış mesaj", homeLink: "Movie Tracker ana sayfa", profileLabel: "Profil", user: "Kullanıcı" },
    ...
    publicProfile: { notFound: "Kullanıcı bulunamadı.", watched: "İzlendi", average: "Ort. Puan", watchedMovies: "İzlediği Filmler", wishlist: "İzleme Listesi", empty: "Bu liste boş.", addFriend: "Arkadaş Ekle", removeFriend: "Arkadaşlıktan Çıkar", message: "Mesaj Gönder", back: "Geri Dön" },
  ...
  en: {
    nav: { home: "Home", discover: "Discover", messages: "Messages", profile: "Profile", search: "Search films...", main: "Main navigation", sidebar: "Sidebar", openMenu: "Open menu", closeMenu: "Close menu", openSidebar: "Open sidebar", closeSidebar: "Close sidebar", mobile: "Mobile navigation", unread: "Unread message", homeLink: "Movie Tracker home", profileLabel: "Profile", user: "User" },
    ...
    comingSoon: { eyebrow: "BEHIND THE SCREEN", title: "Messages are coming soon", description: "We are preparing the messaging area for a better experience. We will meet here very soon.", home: "Back to home" },
    ...
    publicProfile: { notFound: "User not found.", watched: "Watched", average: "Avg. rating", watchedMovies: "Watched films", wishlist: "Watchlist", empty: "This list is empty.", addFriend: "Add friend", removeFriend: "Remove friend", message: "Send message", back: "Back" },
